	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="c")
		{
			echo '<br>Correct Answer</br>';
						echo '<a href="../cssexamination/index.php" class="btn">Start Test</a>';

			//echo 'true';
		}
		else
		{
			echo "<div class='alert alert-danger' role='alert'>Incorrect Answer<br>Correct Answer: padding-center</br></div>";
		}
	}
?>
