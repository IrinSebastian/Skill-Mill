...
<body>
	...
	if(!empty($_POST['id']))
	{
		...
		$headers = "From : skillmill04@gmail.com";
		if($email)
		{
	...
	<hr class="my-6 border-gray-100 sm:mx-auto dark:border-gray-700 lg:my-8">
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 SkillMill™. All Rights Reserved.</span></a>
                </span>
